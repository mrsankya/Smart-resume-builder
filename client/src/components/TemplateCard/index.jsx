...
const SAMPLE_DATA = {
  personalInfo: { fullName: 'Sanket Bhende', email: 'sanket.bhende@email.com', phone: '+91 98765 43210', location: 'Mumbai, India', linkedIn: 'linkedin.com/in/sanketbhende', portfolio: 'sanketbhende.dev' },
